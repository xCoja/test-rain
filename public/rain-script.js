                    ...
                    topUserCard.innerHTML = `
                        ...
                        <div class="card-body">
                            ...
                            <div class="leader-amount">
                                <img src="rain-coin.svg" style="max-width: 20px; vertical-align: middle; margin-bottom: 2px;">
                            ...
                            <div class="leader-points">
                                <img src="rain-coin.svg" style="max-width: 20px; vertical-align: middle; margin-bottom: 3px;" />
            ...
            leaderboard.slice(3).forEach((user, index) => {
                if (user) {
                    ...
                    row.innerHTML = `
                        ...
                        <div class="cell">
                            <div class="wagered">
                                <img src="rain-coin.svg" style="max-width:17px" />
                                ${formattedWageredRow.split('.')[0]}<span style="opacity: .5;">.${formattedWageredRow.split('.')[1]}</span>
                            </div>
                        </div>
                        <div class="cell">
                            <div class="prize">
                                <img src="rain-coin.svg" style="max-width:20px" />
                                ${user.prize || 0}
                            </div>
                        </div>
                    `;
