...
function handleLeaderboard(leaderboard) {
    ...
    const prizeMap = [4000, 2500, 1200, 800, 500, 200, 200, 200, 200, 200];
            ...
            topUserCard.innerHTML = `
                ...
                <div class="card-body">
                   ...
                   <div class="leader-amount">
                    <img src="shockcoin.png" style="max-width: 25px; vertical-align: middle; margin-bottom: 2px;margin-right: -7px;">
                    ...
                    <div class="leader-points">
                        <img src="shockcoin.png" style="max-width: 25px;  vertical-align: middle; margin-bottom: 5px; margin-right: -10px;" />
    ...
    leaderboard.slice(3).forEach((user, index) => {
        if (user) {
            ...
            row.innerHTML = `
                ...
                <div class="cell">
                    <div class="wagered">
                        <img src="shockcoin.png" style="max-width:25px;margin-right: -3px;" />
